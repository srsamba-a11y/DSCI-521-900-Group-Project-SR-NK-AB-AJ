...
This repository focuses on building a reproducible, multi-state dataset from the US DOT  Bureau of Transportation (BTS) Fatality Analysis Reports (FARS) for the years 2022 and 2023.  These datasets are subsets of the U.S. Department of Transportation (USDOT)/Bureau of Transportation Statistics (BTS) National Transportation Atlas Database (NTAD). The following 8 states are included in this analysis:
...
- Use consistent state names; if using state abbreviations adhere to the ISO 3166-2 codes for US states
...
**Sharon Robinson:  Documentation Lead & EDA Team Member**: Authored README, DATA DICTIONARY, and CONTRIBUTION Jupyter Notebook documents; creation of Power Point project presentation; creation and management of GitHub repository and version synchronization; conducted Notification of MVA Crash to EMT Arrival lag-time and EMT Transport to Medical Treatment Facility lag-time analyses
